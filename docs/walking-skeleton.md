...
> **Status note:** this is a target contract, not a claim that every step is shipped. The foundation in [issue #2](https://github.com/abodacs/edu-canvas/issues/2) is shipped; generation and the downstream loop are tracked in the [open issue graph](https://github.com/abodacs/edu-canvas/issues). The current preview correctness blocker is recorded in [issue #27](https://github.com/abodacs/edu-canvas/issues/27). See [`docs/product-strategy.md`](product-strategy.md) for the issue-driven order and seven-layer audit.
...
- [Issue #3](https://github.com/abodacs/edu-canvas/issues/3) is the generation slice; [issue #18](https://github.com/abodacs/edu-canvas/issues/18) adds bounded curriculum and learning-quality validation.
